...
<div class="jumbotron pt-0">
    <div class="container">
        ...
        <br/>
        <p><spring:message code="app.bodyStart"/> <a href="http://projects.spring.io/spring-security/">Spring Security</a>,
...
<div class="container">
    <div class="lead">
        &nbsp;&nbsp;&nbsp;<a href="https://github.com/JavaOPs/topjava"><spring:message code="app.projectName"/></a> <spring:message code="app.projectInfo"/>
    </div>
</div>
